  ...
  return (
    <section className="card p-5 sm:p-6">
      ...
      <p className="mt-4 border-t border-stone-100 pt-4 text-xs leading-5 text-stone-500">
        Food search can use the local offline provider or USDA FoodData Central when a local demo key is configured. Production API access should run through a backend proxy so keys are not exposed in the browser.
      </p>
    </section>
  );
}
