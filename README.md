...
- `edamam`: active external provider for local credential-based experiments.
...
For local experimentation with Edamam, add:

```bash
VITE_EDAMAM_APP_ID=your_demo_app_id
VITE_EDAMAM_APP_KEY=your_demo_app_key
```
